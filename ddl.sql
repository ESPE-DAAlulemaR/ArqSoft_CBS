...
(
	...
	ESTADO varchar(3) NOT NULL,
	FECHA_ULTIMO_INGRESO timestamp with time zone NOT NULL,
	IP_ULTIMO_INGRESO varchar(15) NOT NULL,
	FECHA_CREACION timestamp with time zone NULL,
	FECHA_ACTUALIZACION timestamp with time zone NULL
)
;
...
ALTER TABLE TRANSACCION ADD CONSTRAINT CHK_ESTADO_TRANSACCION CHECK (ESTADO IN ('APR', 'REV', 'PEN'))
;

ALTER TABLE TRANSACCION ADD CONSTRAINT CHK_TIPO_TRANSACCION CHECK (TIPO IN ('DEP', 'PTC', 'CNS', 'REV', 'TRI', 'TRE')
)
;
